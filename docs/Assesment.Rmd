...
---
title: "Exploring Contraceptive Prescription across different Demographics, and its association with Neonatal Outcomes in Scotland "
author: "Maria Amoah"
date: "2024-11-01"
output:
...
The Combined 2022 prescribing data comes from every month in 2022 from the [Public Health Scotalnd Open Prescribing Dataset](https://www.opendata.nhs.scot/dataset/prescriptions-in-the-community). Data on Healthboards and population data on sex and age has been loaded in here.
...
The prescribed drug names come from [NICE](https://bnf.nice.org.uk/treatment-summaries/contraceptives-hormonal/) who list the UK brand names of drugs that are prescribed.
...
```
This table shows that the 16-25 age group has the highest cost per person on these contraceptive types whereas 26-35 has the lowest.
